...
module.exports = class WeatherCommand extends Command {
	...
	async run(msg, args) {
		...
		/*Canvas.registerFont(path.join(__dirname, '..', '..', 'config', 'weather', 'fonts', 'Roboto-Regular.ttf'), { family: 'Roboto' });
		Canvas.registerFont(path.join(__dirname, '..', '..', 'config', 'weather', 'fonts', 'RobotoCondensed-Regular.ttf'), { family: 'Roboto Condensed' });
		Canvas.registerFont(path.join(__dirname, '..', '..', 'config', 'weather', 'fonts', 'RobotoMono-Light.ttf'), { family: 'Roboto Mono' });*/

		if (!config.GoogleAPIKey) return msg.reply('Admin has not set the Google API Key. Go yell at him.');
		if (!config.WeatherAPIKey) return msg.reply('Admin has not set the Weather API Key. Go yell at him.');
		...
		cond.src = await fs.readFileAsync(path.join(__dirname, '..', '..', 'config', 'weather', 'icons', theme, `${icon}.png`));
		humid.src = await fs.readFileAsync(path.join(__dirname, '..', '..', 'config', 'weather', 'icons', theme, 'humidity.png'));
		precip.src = await fs.readFileAsync(path.join(__dirname, '..', '..', 'config', 'weather', 'icons', theme, 'precip.png'));
	...
	getBase(icon) {
		if (icon === 'clear-day' || icon === 'partly-cloudy-day') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'day.png');
		} else if (icon === 'clear-night' || icon === 'partly-cloudy-night') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'night.png');
		} else if (icon === 'rain') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'rain.png');
		} else if (icon === 'thunderstorm') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'thunderstorm.png');
		} else if (icon === 'snow' || icon === 'sleet' || icon === 'fog') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'snow.png');
		} else if (icon === 'wind' || icon === 'tornado') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'windy.png');
		} else if (icon === 'cloudy') {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'cloudy.png');
		} else {
			return path.join(__dirname, '..', '..', 'config', 'weather', 'base', 'cloudy.png');
		}
	}
